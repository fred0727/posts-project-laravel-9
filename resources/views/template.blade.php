    ...
    <div class="container px-4 mx-auto">
        <header class="flex justify-between items-center py-4">
            <div class="flex items-center flex-grow gap-4">
                <a href="{{ route('home') }}">
                    <img src="{{ Vite::asset('resources/images/logo.png') }}" alt="" class="h-12">
                </a>
        ...
        <div class="opactity-60 h-px mb-8" style="
        ...
        <p class="py-16">
            <img src="{{ Vite::asset('resources/images/logo.png') }}" alt="" class="h-12 mx-auto">
        </p>
